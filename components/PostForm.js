    ...
    <form className="mx-5" onSubmit={handlePostSubmit}>
      <div className={(compact ? 'items-center' : '') + " flex"}>
        ...
        <div className="grow pl-2">
          ...
          >{({isUploading}) => (
            <div>
              <textarea className={(compact ? 'h-10 mt-1' : 'h-24')+" w-full p-2 bg-transparent text-nexusWhite"}
                        value={text}
              ...
              <div className="flex -mx-2">
                ...
                {isUploading && (
                  <div className="h-24 w-24 m-2 bg-nexusBorder flex items-center justify-center">
