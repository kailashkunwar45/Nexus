...
export default function PostPage() {
  ...
  return (
    <Layout>
          ...
          {post.parent && (
            <div className="pb-1">
              ...
              <div className="ml-5 h-12 relative">
                <div className="h-20 border-l-2 border-nexusBorder absolute -top-5"
      ...
      {!!userInfo && (
        <div className="border-t border-nexusBorder py-5">
      ...
      <div className="">
        {replies.length > 0 && replies.map(reply => (
          <div className="p-5 border-t border-nexusBorder" key={reply._id}>
